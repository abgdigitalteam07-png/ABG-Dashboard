...
export function PerformanceTab({ brand }: PerformanceTabProps) {
  const ga4 = useMemo(() => generateGA4Data(), [brand.id]);
  const gsc = useMemo(() => generateGSCData(), [brand.id]);
            ...
            <div className="rounded-lg border border-border bg-card p-6 shadow-card">
              ...
              <ResponsiveContainer width="100%" height={260}>
                <LineChart data={ga4.sessionsOverTime}>
                  ...
                  <Line type="linear" dataKey="value" name="Sessions" stroke="#3B82F6" strokeWidth={2} dot={false} activeDot={{ r: 4, strokeWidth: 0 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="rounded-lg border border-border bg-card p-6 shadow-card">
              ...
              <ResponsiveContainer width="100%" height={260}>
                <LineChart data={ga4.activeUsersOverTime}>
                  ...
                  <Line type="linear" dataKey="activeUsers" name="Active Users" stroke="#F97316" strokeWidth={2} dot={false} activeDot={{ r: 4, strokeWidth: 0 }} />
                  <Line type="linear" dataKey="views" name="Views" stroke="#94A3B8" strokeWidth={2} dot={false} activeDot={{ r: 4, strokeWidth: 0 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
          ...
          <div className="rounded-lg border border-border bg-card p-6 shadow-card">
            ...
            <ResponsiveContainer width="100%" height={260}>
              <LineChart data={gsc.clicksImpressionsOverTime}>
                ...
                <Tooltip contentStyle={{ fontSize: 12 }} />
                <Legend wrapperStyle={{ fontSize: 12 }} />
                <Line yAxisId="left" type="linear" dataKey="clicks" name="Clicks" stroke="#3B82F6" strokeWidth={2} dot={false} activeDot={{ r: 4, strokeWidth: 0 }} />
                <Line yAxisId="right" type="linear" dataKey="impressions" name="Impressions" stroke="#F97316" strokeWidth={2} dot={false} activeDot={{ r: 4, strokeWidth: 0 }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
