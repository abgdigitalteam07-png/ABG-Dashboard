...
import { fetchHubSpotData, fetchHubSpotDataBatch, isHubSpotResponseEmpty } from "@/lib/api-client";
      ...
      <WaterFillLoader
        ...
        message={
          isMulti && multiProgress.total > 0
            ? `Loading emails… (${multiProgress.done} of ${multiProgress.total} secondary brands)`
            : "Loading emails…"
        }
      />
    );
